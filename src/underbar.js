(function() {
  ...
  _.reduce = function(collection, iterator, accumulator) {
    //iterate through our collection array
      //if accumlator exists
        //start from your accumulator and add the output from your iterator function    
      //else
      
    var hasAccumulator = accumulator !== undefined; // returns a boolean
